		...
		foreach ($menu_itens as $key => $value) {
			...
			if (is_array($value) && ($value)) {
				...
				foreach ($value as $dropdown_key => $dropdown_value) {
					...
					// <a href...</a>
					$link = Elements::get('link_submenu_ul', [
						$submenu_real_link,
					...
					*/
					...
					// @Harllan
					$submenu_active = ($this->checkActive->link($submenu_real_link)) ? $menu_configs['submenu_item_active_class'] : '';

					// <li>...</li>
					$dropdown_itens.= Elements::get('submenu_item', [
						$submenu_active,
						$link
					]);
					/**
				...
				// <ul class="sub">...</ul>
				$dropdown = Elements::get('submenu', [
					$menu_configs['submenu_class'],
					$dropdown_itens
				]);
				/**
				...
				*/
				...
				// <a href...
				$link = Elements::get('link_with_submenu', [
					$menu_configs['link_class'],
					$active,
					//$menu_data->title,
					$menu_data->icon,
				...
				*/
				...
				$itens.= Elements::get('menu_item', [
					$menu_configs['submenu_item_class'],
					$active,
					$link
				]);
				/**
